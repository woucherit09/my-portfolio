...
export const valuePoints = [
  {
    ...
    text: "Сначала разберусь в проблеме — потом предложу формат, который реально нужен вам.",
  },
  {
    title: "Без лишнего",
    text: "Не раздуваю объём ради цены. Делаю то, что двигает бизнес и продукт вперёд.",
  },
  {
    title: "До результата",
    text: "От идеи до работающего релиза: интерфейс, логика, база и запуск.",
  },
];
