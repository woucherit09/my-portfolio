/**
 * LiquidEther — vanilla port of the React Bits WebGL fluid background.
 * Original component author: React Bits. Adapted here to run without React,
 * driven by a single container element and Three.js (loaded globally as THREE).
 */
(function () {
  "use strict";
  ...
  function initLiquidEther(container, userOptions) {
    ...
    class MouseClass {
      constructor() {
        ...
        this._onLeave = this.onDocumentLeave.bind(this);
      }
      init(el) {
        this.container = el;
    ...
    class WebGLManager {
      constructor(props) {
        ...
        this._onVisibility = () => {
          ...
          else if (sectionVisible) this.start();
        };
    ...
    const ro = new ResizeObserver(() => {
      ...
      resizeRafId = requestAnimationFrame(() => webgl.resize());
    });
